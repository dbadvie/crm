...
use Modules\FileManager\Events\Deleted;
use Modules\FileManager\Http\Traits\CheckTrait;
use Modules\FileManager\Http\Traits\ContentTrait;
use Modules\FileManager\Http\Traits\PathTrait;
use Modules\FileManager\Repositories\TransferFactory;
