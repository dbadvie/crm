...
<body class="vertical-layout  vertical-menu-modern  blank-page {{ $configData['blankPageClass'] }} {{ $configData['bodyClass'] }} {{($configData['theme'] === 'dark' || $configData['theme'] === 'semi-dark' ) ? 'dark-layout' : 'light' }}"
