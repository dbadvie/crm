...
<div class="misc-wrapper">
  ...
  <div class="misc-inner p-2 p-sm-3">
    <div class="w-100 text-center">
      ...
      <img class="img-fluid" src="{{asset('assets/images/pages/coming-soon-dark.svg')}}" alt="Coming soon page" />
      @else
      <img class="img-fluid" src="{{asset('assets/images/pages/coming-soon.svg')}}" alt="Coming soon page" />
      @endif
    </div>
  </div>
</div>
