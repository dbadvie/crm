...
<div class="misc-wrapper">
  ...
  <div class="misc-inner p-2 p-sm-3">
    <div class="w-100 text-center">
      ...
      <img class="img-fluid" src="{{asset('assets/images/pages/error-dark.svg')}}" alt="Error page" />
      @else
      <img class="img-fluid" src="{{asset('assets/images/pages/error.svg')}}" alt="Error page" />
      @endif
    </div>
  </div>
</div>
