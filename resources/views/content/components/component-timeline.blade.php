          ...
          <ul class="timeline">
            <li class="timeline-item">
              ...
              <div class="timeline-event">
                ...
                <div class="media align-items-center">
                  <img
                    class="mr-1"
                    src="{{asset('assets/images/icons/file-icons/pdf.png')}}"
                    alt="invoice"
                    height="23"
                  />
            ...
            <li class="timeline-item">
              ...
              <div class="timeline-event">
                ...
                <div class="media align-items-center">
                  <div class="avatar">
                    <img src="{{asset('assets/images/avatars/12-small.png')}}" alt="avatar" height="38" width="38" />
                  </div>
                ...
                <div class="d-flex justify-content-between flex-sm-row flex-column mb-sm-0 mb-1">
                  <div class="media align-items-center">
                    <div class="avatar mr-1">
                      <img src="{{asset('assets/images/avatars/1-small.png')}}" alt="Avatar" height="32" width="32" />
                    </div>
                ...
                <div>
                  ...
                  <div class="avatar-group mt-50">
                    ...
                    >
                      <img
                        class="media-object"
                        src="{{asset('assets/images/portrait/small/avatar-s-5.jpg')}}"
                        alt="Avatar"
                        height="30"
                        width="30"
                      />
