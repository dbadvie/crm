          ...
          <div class="media-list">
            <div class="media">
              ...
              <div class="media-right">
                <img
                  ...
                  src="{{asset('assets/images/portrait/small/avatar-s-10.jpg')}}"
                  alt="avatar"
                  height="64"
                  width="64"
                />
            ...
            <div class="media">
              ...
              <div class="media-right">
                <img
                  class="rounded-circle cursor-pointer"
                  src="{{asset('assets/images/portrait/small/avatar-s-7.jpg')}}"
                  alt="avatar"
                  height="64"
                  width="64"
                />
            ...
            <div class="media">
              ...
              <div class="media-right">
                <img
                  class="rounded-circle cursor-pointer"
                  src="{{asset('assets/images/portrait/small/avatar-s-2.jpg')}}"
                  alt="avatar"
                  height="64"
                  width="64"
                />
        ...
        <div class="card-body">
          ...
          <div class="media-list media-bordered">
            <div class="media">
              <div class="media-left">
                <img
                  src="{{asset('assets/images/portrait/small/avatar-s-23.jpg')}}"
                  alt="avatar"
                  height="64"
                  width="64"
                  class="cursor-pointer"
          ...
          <div class="media-list media-bordered">
            ...
            <div class="media">
              ...
              <div class="media-right">
                <img
                  class="rounded-circle cursor-pointer"
                  src="{{asset('assets/images/portrait/small/avatar-s-14.jpg')}}"
                  alt="avatar"
                  height="64"
                  width="64"
                />
            ...
            <div class="media">
              ...
              <div class="media-right">
                <img
                  class="rounded-circle cursor-pointer"
                  src="{{asset('assets/images/portrait/small/avatar-s-21.jpg')}}"
                  alt="avatar"
                  height="64"
                  width="64"
                />
    ...
    <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="media">
            <img
              src="{{asset('assets/images/portrait/small/avatar-s-12.jpg')}}"
              class="mr-1"
              alt="avatar"
              height="64"
              width="64"
          ...
          <div class="media-list media-bordered">
            <div class="media">
              <div class="align-self-start media-left">
                <img
                  src="{{asset('assets/images/portrait/small/avatar-s-4.jpg')}}"
                  alt="avatar"
                  height="64"
                  width="64"
                  class="cursor-pointer"
