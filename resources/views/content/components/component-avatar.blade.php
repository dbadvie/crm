        ...
        <div class="card-body">
          ...
          <div class="demo-inline-spacing">
            <div class="avatar avatar-sm">
              <img src="{{asset('assets/images/portrait/small/avatar-s-20.jpg')}}" alt="avatar" />
            </div>
            <div class="avatar">
              <img
        ...
        <div class="card-body">
          ...
          <div class="avatar-group">
            <div class="avatar pull-up">
              <img src="{{asset('assets/images/portrait/small/avatar-s-5.jpg')}}" alt="Avatar" height="32" width="32" />
            </div>
            <div class="avatar pull-up">
              <img src="{{asset('assets/images/portrait/small/avatar-s-7.jpg')}}" alt="Avatar" height="32" width="32" />
            </div>
            <div class="avatar pull-up">
              <img
            ...
            <div class="avatar pull-up">
              <img src="{{asset('assets/images/portrait/small/avatar-s-8.jpg')}}" alt="Avatar" height="32" width="32" />
            </div>
            <div class="avatar pull-up">
              <img
                src="{{asset('assets/images/portrait/small/avatar-s-20.jpg')}}"
