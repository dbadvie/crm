          ...
          <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="img-fluid" src="{{asset('assets/images/slider/02.jpg')}}" alt="First slide" />
              </div>
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/03.jpg')}}" alt="Second slide" />
              </div>
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/01.jpg')}}" alt="Third slide" />
              </div>
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div id="carousel-example-caption" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="img-fluid" src="{{asset('assets/images/slider/09.jpg')}}" alt="First slide" />
              ...
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/08.jpg')}}" alt="Second slide" />
                <div class="carousel-caption">
              ...
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/10.jpg')}}" alt="Third slide" />
                <div class="carousel-caption">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div id="carousel-interval" class="carousel slide" data-ride="carousel" data-interval="5000">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="img-fluid" src="{{asset('assets/images/slider/01.jpg')}}" alt="First slide" />
              </div>
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/03.jpg')}}" alt="Second slide" />
              </div>
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/02.jpg')}}" alt="Third slide" />
              </div>
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div id="carousel-pause" class="carousel slide" data-ride="carousel" data-pause="hover">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="img-fluid" src="{{asset('assets/images/slider/06.jpg')}}" alt="First slide" />
              </div>
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/04.jpg')}}" alt="Second slide" />
              </div>
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/05.jpg')}}" alt="Third slide" />
              </div>
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div id="carousel-keyboard" class="carousel slide" data-keyboard="true">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="img-fluid" src="{{asset('assets/images/slider/03.jpg')}}" alt="First slide" />
              </div>
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/06.jpg')}}" alt="Second slide" />
              </div>
              <div class="carousel-item">
                <img class="img-fluid" src="{{asset('assets/images/slider/01.jpg')}}" alt="Third slide" />
              </div>
        ...
        <div class="card-body">
          ...
          <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="{{asset('assets/images/slider/06.jpg')}}" class="img-fluid d-block w-100" alt="cf-img-1" />
              </div>
              <div class="carousel-item">
                <img src="{{asset('assets/images/slider/02.jpg')}}" class="img-fluid d-block w-100" alt="cf-img-2" />
              </div>
              <div class="carousel-item">
                <img src="{{asset('assets/images/slider/05.jpg')}}" class="img-fluid d-block w-100" alt="cf-img-3" />
              </div>
            </div>
