      ...
      <div class="mt-75">
        <div class="media mb-2">
          <a href="{{asset('page/blog/detail')}}" class="mr-2">
            <img
              class="rounded"
              src="{{asset('assets/images/banner/banner-22.jpg')}}"
              width="100"
              height="70"
              alt="Recent Post Pic"
            />
        ...
        <div class="media mb-2">
          <a href="{{asset('page/blog/detail')}}" class="mr-2">
            <img
              class="rounded"
              src="{{asset('assets/images/banner/banner-27.jpg')}}"
              width="100"
              height="70"
              alt="Recent Post Pic"
            />
        ...
        <div class="media mb-2">
          <a href="{{asset('page/blog/detail')}}" class="mr-2">
            <img
              class="rounded"
              src="{{asset('assets/images/banner/banner-39.jpg')}}"
              width="100"
              height="70"
              alt="Recent Post Pic"
            />
        ...
        <div class="media">
          <a href="{{asset('page/blog/detail')}}" class="mr-2">
            <img
              class="rounded"
              src="{{asset('assets/images/banner/banner-35.jpg')}}"
              width="100"
              height="70"
              alt="Recent Post Pic"
            />
