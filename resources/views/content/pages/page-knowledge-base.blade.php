  ...
  <div class="row kb-search-content-info match-height">
    ...
    <div class="col-md-4 col-sm-6 col-12 kb-search-content">
      <div class="card">
        <a href="{{asset('page/knowledge-base/category')}}">
          <img
            src="{{asset('assets/images/illustration/sales.svg')}}"
            class="card-img-top"
    ...
    <div class="col-md-4 col-sm-6 col-12 kb-search-content">
      <div class="card">
        <a href="{{asset('page/knowledge-base/category')}}">
          <img
            src="{{asset('assets/images/illustration/marketing.svg')}}"
            class="card-img-top"
            alt="knowledge-base-image"
          />
          <div class="card-body text-center">
    ...
    <div class="col-md-4 col-sm-6 col-12 kb-search-content">
      <div class="card">
        <a href="{{asset('page/knowledge-base/category')}}">
          <img src="{{asset('assets/images/illustration/api.svg')}}" class="card-img-top" alt="knowledge-base-image" />
          <div class="card-body text-center">
            <h4>API Questions</h4>
    ...
    <div class="col-md-4 col-sm-6 col-12 kb-search-content">
      <div class="card">
        <a href="{{asset('page/knowledge-base/category')}}">
          <img
            src="{{asset('assets/images/illustration/personalization.svg')}}"
            class="card-img-top"
            alt="knowledge-base-image"
          />
          <div class="card-body text-center">
    ...
    <div class="col-md-4 col-sm-6 col-12 kb-search-content">
      <div class="card">
        <a href="{{asset('page/knowledge-base/category')}}">
          <img
            src="{{asset('assets/images/illustration/email.svg')}}"
            class="card-img-top"
            alt="knowledge-base-image"
          />
          <div class="card-body text-center">
    ...
    <div class="col-md-4 col-sm-6 col-12 kb-search-content">
      <div class="card">
        <a href="{{asset('page/knowledge-base/category')}}">
          <img
            src="{{asset('assets/images/illustration/demand.svg')}}"
            class="card-img-top"
            alt="knowledge-base-image"
          />
          <div class="card-body text-center">
