...
@section('page-style')
  {{-- Page css files --}}
  <link rel="stylesheet" href="{{ asset('assets/css/base/pages/dashboard-ecommerce.css')) }}">
  <link rel="stylesheet" href="{{ asset('assets/css/base/plugins/charts/chart-apex.css')) }}">
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="{{asset('assets/images/icons/toolbox.svg')}}" alt="Toolbar svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="{{asset('assets/images/icons/parachute.svg')}}" alt="Parachute svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="{{asset('assets/images/icons/brush.svg')}}" alt="Brush svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="{{asset('assets/images/icons/star.svg')}}" alt="Star svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="{{asset('assets/images/icons/book.svg')}}" alt="Book svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="{{asset('assets/images/icons/rocket.svg')}}" alt="Rocket svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="{{asset('assets/images/icons/speaker.svg')}}" alt="Speaker svg" />
                        </div>
                      </div>
                      <div>
