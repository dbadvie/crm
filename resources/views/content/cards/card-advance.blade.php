  ...
  <div class="col-12 col-md-6 col-lg-7">
    <div class="card card-congratulations">
      <div class="card-body text-center">
        <img
          src="{{asset('assets/images/elements/decore-left.png')}}"
          class="congratulations-img-left"
          alt="card-img-left"
        />
        <img
          src="{{asset('assets/images/elements/decore-right.png')}}"
      ...
      <div class="card-body">
        <div class="employee-task d-flex justify-content-between align-items-center">
          <div class="media">
            <div class="avatar mr-75">
              <img
                src="{{asset('assets/images/portrait/small/avatar-s-9.jpg')}}"
                class="rounded"
                width="42"
                height="42"
                alt="Avatar"
        ...
        <div class="employee-task d-flex justify-content-between align-items-center">
          <div class="media">
            <div class="avatar mr-75">
              <img
                src="{{asset('assets/images/portrait/small/avatar-s-20.jpg')}}"
                class="rounded"
                width="42"
                height="42"
                alt="Avatar"
        ...
        <div class="employee-task d-flex justify-content-between align-items-center">
          <div class="media">
            <div class="avatar mr-75">
              <img
                src="{{asset('assets/images/portrait/small/avatar-s-1.jpg')}}"
                class="rounded"
                width="42"
                height="42"
                alt="Avatar"
        ...
        <div class="employee-task d-flex justify-content-between align-items-center">
          <div class="media">
            <div class="avatar mr-75">
              <img
                src="{{asset('assets/images/portrait/small/avatar-s-13.jpg')}}"
                class="rounded"
                width="42"
                height="42"
                alt="Avatar"
      ...
      <div class="card-body">
        <div class="profile-image-wrapper">
          <div class="profile-image">
            <div class="avatar">
              <img src="{{asset('assets/images/portrait/small/avatar-s-9.jpg')}}" alt="Profile Picture" />
            </div>
          </div>
        </div>
        <h3>Curtis Stone</h3>
          ...
          <li class="timeline-item">
            ...
            <div class="timeline-event">
              ...
              <div class="avatar-group">
                ...
                >
                  <img
                    src="{{asset('assets/images/portrait/small/avatar-s-6.jpg')}}"
                    alt="Avatar"
                    width="33"
                    height="33"
                  />
                ...
                >
                  <img
                    src="{{asset('assets/images/portrait/small/avatar-s-8.jpg')}}"
                    alt="Avatar"
                    width="33"
                    height="33"
                  />
      ...
      <div class="card-header">
        <div class="d-flex align-items-center">
          <div class="avatar mr-2">
            <img src="{{asset('assets/images/portrait/small/avatar-s-20.jpg')}}" alt="Avatar" width="34" height="34" />
    ...
    <div class="card card-browser-states">
      ...
      <div class="card-body">
        ...
        <div class="browser-states">
          <div class="media">
            <img
              src="{{asset('assets/images/icons/google-chrome.png')}}"
              class="rounded mr-1"
              height="30"
              alt="Google Chrome"
            />
        ...
        <div class="browser-states">
          <div class="media">
            <img
              src="{{asset('assets/images/icons/mozila-firefox.png')}}"
              class="rounded mr-1"
              height="30"
              alt="Mozila Firefox"
            />
        ...
        <div class="browser-states">
          <div class="media">
            <img
              src="{{asset('assets/images/icons/apple-safari.png')}}"
              class="rounded mr-1"
              height="30"
              alt="Apple Safari"
            />
        ...
        <div class="browser-states">
          <div class="media">
            <img
              src="{{asset('assets/images/icons/internet-explorer.png')}}"
              class="rounded mr-1"
              height="30"
    ...
    <div class="card card-app-design">
      <div class="card-body">
        ...
        <div class="design-group">
          ...
          <div class="avatar">
            <img src="{{asset('assets/images/portrait/small/avatar-s-20.jpg')}}" width="34" height="34" alt="Avatar" />
          </div>
